...
export class ModalElement extends IElement {
	...
	/** 弹窗标题 */
	_title: HTMLDivElement = h('div', { className: 'modal-title' });
	/** 弹窗主体  */
	body: HTMLDivElement = h('div', { className: 'modal-body' });
	/** 弹窗底部 */
	footerContainer: HTMLDivElement = h('div', { className: 'modal-footer' });
	...
	/** 弹窗底部输入框 */
	modalInput: HTMLInputElement | HTMLTextAreaElement = h('input', { className: 'modal-input' });
